...
Fonctionnalités techniques
    ...
    Chargement automatisé : Les images et textes sont générés via JavaScript à partir d'un fichier de données (data.js), permettant une mise à jour facile.
    Design / Pattern : Alternance automatique gauche/droite gérée par CSS Grid.
    Interactivité : Système de zoom (popup) avec transition CSS. Validation de formulaire intégrée.
...
3. Tests et Validation :
    ...
    Accéder à mon site via l'URL : http://localhost/sae105/ L’URL localhost n’est accessible que lorsque le serveur Apache de XAMPP est démarré.
